...
This task will help you setup a new GCP project in which to run angular application. **(you can also use an existing project and skip to the next
step)**
...
```
6. Add the prerender typscript file to git
```
...
3. Delete the Build Trigger
    ...
    1. On the line of the build trigger "tour-of-heroes-universal" select the menu ![trigger button](trigger-button.png)
    1. Select "Delete"
